...
// https://api.rawg.io/api/games?key=1aa3bb39c3334036a3e8b13aefa463d3
...
function exibePesquisa () {
    ...
    let sectionConteudoPesquisa = document.getElementById('tela');
    let str = sectionConteudoPesquisa.innerHTML;
...
xhr.open ('GET', `https://api.rawg.io/api/games?key=${API_KEY}&query=${query}`);
xhr.send ();

document.getElementById ('btnPesquisa').addEventListener ('click', exibePesquisa);